...
public static class CacheExtensions
{
    ...
    public static async Task<T> CacheAgencyQuery<T>(this IMemoryCache cache, string key, Func<Task<T>> query, ILoggingService loggingService, ApplicationSettings appSettings)
    {
        // Si el caché está deshabilitado, ejecutar la consulta directamente
        if (!appSettings.Cache.Enabled)
        {
