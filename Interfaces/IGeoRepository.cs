...
public interface IGeoRepository
{
    ...
    Task<dynamic> GetRegionsByCityId(int cityId, bool forDropdown);
    ...
    Task<dynamic> GetCitiesByRegionId(int regionId, bool forDropdown);
    ...
    Task<dynamic> GetAllCitiesFromDb(int take, int skip, string name, bool alls, bool forDropdown);
    ...
    Task<dynamic> GetAllRegionsFromDb(int take, int skip, string name, bool alls, bool forDropdown);
