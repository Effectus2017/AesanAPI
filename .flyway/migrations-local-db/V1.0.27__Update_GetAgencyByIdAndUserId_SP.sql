CREATE OR ALTER PROCEDURE [104_GetAgencyByIdAndUserId]
    @agencyId INT = NULL,
    @userId NVARCHAR(450)
AS
BEGIN
    ...
    LEFT JOIN AgencyUsers auaSponsor ON a.Id = auaSponsor.AgencyId AND auaSponsor.IsActive = 1 AND auaSponsor.IsSponsor = 1
