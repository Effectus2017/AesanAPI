...
-- Archivo original: /Volumes/Mac/Proyectos/AESAN/Proyecto/Api/Database/StoredProcedures/Agency/105_GetAgencies.sql
-- =============================================
...
BEGIN
    ...
    GROUP BY 
        ...
        a.ServiceTime, a.TaxExemptionStatus, a.TaxExemptionType,  -- Nuevas propiedades
