CREATE OR ALTER PROCEDURE [103_GetAgencies]
    @take INT,
    @skip INT,
    @name VARCHAR(255),
    @alls BIT,
...
BEGIN
    ...
    FROM Agency a
        ...
        -- Agregamos el JOIN con UserAgencyAssignment para filtrar por usuario asignado
    ...
    WHERE (@alls = 1)
        ...
        -- Modificamos la condición para incluir agencias asignadas al usuario
