-- =============================================
-- Stored Procedure: 100_UpdateAgencyInscriptionBoardExecutiveAuthority
-- Descripción: Actualiza múltiples funciones de autoridad de la Junta de Directores para una inscripción de agencia
-- Fecha: 2025-03-14
-- Versión: 1.0
-- =============================================

CREATE OR ALTER PROCEDURE [dbo].[100_UpdateAgencyInscriptionBoardExecutiveAuthority]
