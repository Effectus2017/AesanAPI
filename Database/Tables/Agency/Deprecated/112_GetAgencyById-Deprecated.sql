...
-- Versión actualizada siguiendo el patrón de 117_GetAgencies.sql
CREATE OR ALTER PROCEDURE [112_GetAgencyById]
    @id INT
AS
BEGIN
    SET NOCOUNT ON;

    -- Primer result set: Datos de la agencia
    SELECT
        a.Id,
        a.Name,
