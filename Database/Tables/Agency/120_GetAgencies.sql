-- =============================================
-- Stored Procedure: 120_GetAgencies
-- Fecha: 2026-03-03
-- Descripción: Versión de 119_GetAgencies que añade acceso por UserProgram: cualquier
--              usuario con fila en UserProgram (programa asignado) ve las agencias que
--              tienen ese programa en AgencyProgram, sin necesidad de AgencyUsers.
--              Misma estructura y result sets que 119_GetAgencies.
--              Acceso: admin; o AgencyUsers para esa agencia; o UserProgram activo
--              para un programa que la agencia tenga en AgencyProgram.
-- =============================================

CREATE OR ALTER PROCEDURE [120_GetAgencies]
    @take INT = 10000000,
    @skip INT = 0,
