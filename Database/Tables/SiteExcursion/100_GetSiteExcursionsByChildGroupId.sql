-- =============================================
-- Stored Procedure: 100_GetSiteExcursionsByChildGroupId
-- Descripción: Obtiene excursiones de un sitio por grupo de niños
-- Fecha: 2025-03-14
-- Versión: 1.0
-- =============================================

CREATE OR ALTER PROCEDURE [dbo].[100_GetSiteExcursionsByChildGroupId]
    @siteId INT,
    @childGroupId INT,
...
BEGIN
    ...
    -- Obtener excursiones del sitio para el grupo específico
    SELECT
    ...
    WHERE se.SiteId = @siteId
        AND se.ChildGroupId = @childGroupId
