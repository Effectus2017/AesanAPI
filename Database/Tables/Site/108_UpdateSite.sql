-- =============================================
-- Stored Procedure: 104_UpdateSite (versión 108)
-- Descripción: Actualiza un sitio existente; incluye Horario Académico (FirstAcademicClassStartTime, LastAcademicClassEndTime)
-- Fecha: 2026-02-02
-- =============================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        SET 
            ...
            FirstAcademicClassStartTime = ISNULL(@firstacademicclassstarttime, FirstAcademicClassStartTime),
            LastAcademicClassEndTime = ISNULL(@lastacademicclassendtime, LastAcademicClassEndTime),
            ...
            DiningRoomCapacity = ISNULL(@diningRoomCapacity, DiningRoomCapacity),
