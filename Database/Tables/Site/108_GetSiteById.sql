-- =============================================
-- Stored Procedure: 105_GetSiteById (versión 108)
-- Descripción: Obtiene un sitio por su ID; incluye Horario Académico (FirstAcademicClassStartTime, LastAcademicClassEndTime)
-- Fecha: 2026-02-02
-- =============================================
...
BEGIN
    ...
    SELECT
        ...
        s.OperatingStartTime, s.OperatingEndTime, s.FirstAcademicClassStartTime, s.LastAcademicClassEndTime,
