-- =============================================
-- Stored Procedure: 101_GetStaffByAgency
-- =============================================
-- Obtiene todos los miembros del staff de una agencia específica (v101).
-- Incluye columna HasRelationships para compatibilidad con StaffTableResponse.
--
-- Parámetros:
...
CREATE OR ALTER PROCEDURE [dbo].[101_GetStaffByAgency]
    @agencyId INT,
    @take INT = 15,
    @skip INT = 0,
