-- =============================================
-- DEPRECATED: Este SP ha sido reemplazado por 105_GetSiteById
-- Fecha de deprecación: 2025-01-15
-- Razón: Migración de School a Site
-- =============================================

CREATE OR ALTER PROCEDURE [dbo].[105_GetSchoolById]
    @id INT
AS
BEGIN
    SET NOCOUNT ON;
    ...
    SELECT
        ...
        s.LocationTypeId,
        ltype.Name AS LocationTypeName,
        ltype.NameEN AS LocationTypeNameEN,
        s.HasWarehouse,
        s.HasDiningRoom,
    ...
    -- Obtener servicios de alimentación de la escuela (ACTUALIZADO CON NUEVOS CAMPOS)
    SELECT
        ss.Id,
        ss.SchoolId,
        ss.ChildGroupId,
