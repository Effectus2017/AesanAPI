-- Limpiar tabla antes de insertar nuevas relaciones
TRUNCATE TABLE DeliveryTypeProgram;

-- Insertar relaciones entre DeliveryType y Program
-- Basado en las reglas de negocio actualizadas:
...
-- PSAV (Id=2): Auspiciador Entrega, Centro Comunal, Domicilio, Recogido de Padre o Encargado, Servi-Carro, Servi-Expreso, N/A
...
DECLARE @DeliveryTypeNA INT = (SELECT Id
FROM DeliveryType
WHERE Name = 'N/A');
DECLARE @DeliveryTypeSitioRecoge INT = (SELECT Id
FROM DeliveryType
WHERE Name = 'Sitio Recoge');
DECLARE @DeliveryTypeAuspiciadorEntrega INT = (SELECT Id
FROM DeliveryType
WHERE Name = 'Auspiciador Entrega');
DECLARE @DeliveryTypeCentroComunal INT = (SELECT Id
FROM DeliveryType
WHERE Name = 'Centro Comunal');
DECLARE @DeliveryTypeDomicilio INT = (SELECT Id
FROM DeliveryType
WHERE Name = 'Domicilio');
DECLARE @DeliveryTypeRecogidoPadreEncargado INT = (SELECT Id
FROM DeliveryType
WHERE Name = 'Recogido de Padre o Encargado');
DECLARE @DeliveryTypeServiCarro INT = (SELECT Id
FROM DeliveryType
WHERE Name = 'Servi-Carro');
DECLARE @DeliveryTypeServiExpreso INT = (SELECT Id
FROM DeliveryType
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeNA, @ProgramPDAM);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeSitioRecoge, @ProgramPDAM);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeAuspiciadorEntrega, @ProgramPDAM);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeCentroComunal, @ProgramPDAM);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeDomicilio, @ProgramPDAM);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeRecogidoPadreEncargado, @ProgramPDAM);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeServiCarro, @ProgramPDAM);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeServiExpreso, @ProgramPDAM);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeAuspiciadorEntrega, @ProgramPSAV);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeCentroComunal, @ProgramPSAV);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeDomicilio, @ProgramPSAV);
END

IF @ProgramPSAV IS NOT NULL AND @DeliveryTypeRecogidoPadreEncargado IS NOT NULL
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeRecogidoPadreEncargado, @ProgramPSAV);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeServiCarro, @ProgramPSAV);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeServiExpreso, @ProgramPSAV);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeAuspiciadorEntrega, @ProgramPACNA);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeCentroComunal, @ProgramPACNA);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeDomicilio, @ProgramPACNA);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeRecogidoPadreEncargado, @ProgramPACNA);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeServiCarro, @ProgramPACNA);
END
...
BEGIN
    INSERT INTO DeliveryTypeProgram
        (DeliveryTypeId, ProgramId)
    VALUES
        (@DeliveryTypeServiExpreso, @ProgramPACNA);
END
