-- Stored Procedure para insertar días de funcionamiento de una escuela
...
CREATE OR ALTER PROCEDURE [dbo].[100_InsertSchoolOperatingDays]
    @SchoolId INT,
...
BEGIN
    ...
    BEGIN TRY
        -- Validar parámetros
        IF @SchoolId IS NULL OR @OperatingFromDate IS NULL OR @OperatingToDate IS NULL
        BEGIN
        RAISERROR('SchoolId, OperatingFromDate y OperatingToDate son requeridos', 16, 1);
        RETURN;
    END
    ...
    END
        ...
        DELETE FROM SchoolOperatingDays 
