...
(
    ...
    -- Nombre y Apellidos del Administrador/Representante
    ...
    -- Tipo de Cocina (catálogo)
    GroupTypeId INT NULL,
    -- Tipo de Grupo (catálogo)
    DeliveryTypeId INT NULL,
    -- Tipo de Entrega (catálogo)
    SponsorTypeId INT NULL,
    -- Tipo de Auspiciador (catálogo)
    ApplicantTypeId INT NULL,
    -- Tipo de Solicitante (catálogo)
    OperatingPolicyId INT NULL,
    -- Política de Funcionamiento (catálogo)
