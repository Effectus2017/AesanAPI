CREATE OR ALTER PROCEDURE [dbo].[103_InsertSchool]
    @agencyId INT,
    @name NVARCHAR(255),
    @startDate DATE = NULL,
...
BEGIN
    ...
    INSERT INTO School
        ...
        KitchenTypeId, GroupTypeId, DeliveryTypeId, SponsorTypeId, ApplicantTypeId, ResidentialTypeId, OperatingPolicyId, AreaTypeId,
