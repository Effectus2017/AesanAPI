...
/// Contiene todos los métodos de mapeo para SchoolResponse y objetos relacionados
/// </summary>
public class SchoolMapper(Lazy<MappingService> mappingService)
{
    ...
    /// <summary>
    /// Mapea un resultado dinámico a un SchoolListItemResponse simplificado para listas
    /// </summary>
    /// <param name="item">Resultado dinámico</param>
    /// <returns>SchoolListItemResponse</returns>
    public static SchoolListItemResponse MapListItemFromResult(dynamic item)
    {
        try
        {
            if (item == null)
